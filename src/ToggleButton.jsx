...
const ToggleButton = (props) => {
    const { onColor = 'bg-cyan-800', offColor = 'bg-gray-500', onClick } = props
  ...
  return (
    ...
    >
      <div
        className={`w-6 h-6 bg-bgMain rounded-full shadow-md transform transition-transform duration-300 ${
